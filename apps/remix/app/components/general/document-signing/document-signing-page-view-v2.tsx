...
export const DocumentSigningPageViewV2 = () => {
  return (
    <DiffProvider>
      <ClauseHighlightProvider>
        <DocumentSigningPageViewV2Inner />
      </ClauseHighlightProvider>
    </DiffProvider>
  );
};

const DocumentSigningPageViewV2Inner = () => {
        ...
        >
          ...
          >
            <div className="flex-1 overflow-y-auto">
              ...
              {/* Document Review — first thing visible after status */}
              ...
              {/* Signing fields */}
              <div className="px-4">
                <div className="embed--DocumentWidgetContent space-y-3">
                  <EnvelopeSignerForm />
                </div>
              </div>
